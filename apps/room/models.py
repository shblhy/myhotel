...
class RoomHistory(models.Model):
    ...
    comment = models.CharField(_(u'介绍'), max_length=2000)
    status = models.SmallIntegerField(_(u'状态'), choices=Room.RoomStatusChoices.items(), default=0)
    #rtype = models.SmallIntegerField(_(u'类别'), choices=Room.RoomTypeChoices.items(), default=0)
    HistoryTypeChoices = {
                          0: '使用',
                          1: '编辑',
                          }
