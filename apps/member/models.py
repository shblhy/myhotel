...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    real_name = models.CharField(_('实名'), max_length=30, blank=True)
    ...
    phone = models.CharField(_('手机'), max_length=30, blank=True)
    is_staff = models.BooleanField(_('超级管理员'), default=False,
        help_text=_('Designates whether the user can log into this admin '
                    'site.'))
    is_active = models.BooleanField(_('活动的'), default=True,
