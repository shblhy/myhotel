...
(function(window, undefined) {
	...
	// prevent console warnings from being generated in the debugging version.
	...
	//$$ 插入 jQuery Migrate - v1.1.1 - 2013-02-16
	...
	var attrFn = jQuery("<input/>", {
		size : 1
	}).attr("size") && jQuery.attrFn, oldAttr = jQuery.attr, valueAttrGet = jQuery.attrHooks.value && jQuery.attrHooks.value.get ||
	function() {
		return null;
