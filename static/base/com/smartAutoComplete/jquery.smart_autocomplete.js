  ...
  $.fn.smartAutoComplete = function() {
    ...
    var default_options = {
      ...
      clearResults: function() {
        ...
        $(this.context).css({
          background: type_ahead_field.css("background")
        });
      ...
      **/
      setItemSelected: function(selected, input_value, selected_value, $input) {
        if (selected) {
        ...
        if (results_container) {
          if (options.alignResultsContainer) {
            results_container.css({
              position: "absolute",
              top: function() {
                return $(context).offset().top + $(context).height();
              },
              left: function() {
    ...
    $.event.special.itemSelect = {
      ...
      _default: function(ev) {
        ...
        **/
        $(context).val(options.setItemSelected(true, $(context).val(), selected_value, $(context)));
        /**end1**/
    ...
    return this.each(function(i) {
      ...
      $(this).bind({
        keyIn: function(ev, query) {
          ev.smartAutocompleteData = {
            "query": query
          };
        },
        resultsReady: function(ev, results) {
          ev.smartAutocompleteData = {
            "results": results
          };
        },
        showResults: function(ev, results) {
          ev.smartAutocompleteData = {
            "results": results
          }
        },
